...
public class Pre_Deal {
	...
	public static void main(String[] args) throws IOException {
		...
		indexs = new TreeMap<String, TreeMap<String, Integer>>();
		d_len = new TreeMap<String, Integer>();
		File data_set = new File("D:\\data_original");				//打开原始数据集（包含262个txt文件）
...
//			indexs.remove(" ");
	...
	public static void write_d_len() throws IOException{
		FileOutputStream out = new FileOutputStream(new File("D:\\我的文档\\专业课文档\\信息检索\\信息检索大作业\\d_len.txt"));
	...
	public static void write_indexs() throws IOException{
		FileOutputStream out = null;//
		out = new FileOutputStream(new File("D:\\我的文档\\专业课文档\\信息检索\\信息检索大作业\\indexs.txt"));
	...
	public static String get_title(String line1, String line2, File file) throws IOException{
		...
		out = new FileOutputStream(new File("D:\\data_complete\\"+file.getName()));
